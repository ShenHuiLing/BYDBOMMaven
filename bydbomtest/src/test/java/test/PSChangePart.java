...
public class PSChangePart extends BTest{
  ...
  public void PSpublishPartChange() throws IOException {
	  try {
		  ...
		  page.link.clickLinkByText("维护");
		  Thread.sleep(1000);
		  
		  //fill the change contents
		  logger.info("select change type");
		  labelId=page.otherElements.getLabelId(LabelStyle.GANTCODETYPECOMBOBOX,"零件变更类型",0);
		  page.option.expandDropdownList(DropDownListStyle.GANTCODETYPECOMBOBOX,labelId);
		  Thread.sleep(2000);
		  page.option.selectOption("删除");
		  Thread.sleep(1000);
		  
		  logger.info("fill the quantity change");
		  labelId=page.otherElements.getLabelId(LabelStyle.TEXTFIELD,"数量变化",0);
		  page.text.openTextBox(TextStyle.IDININPUT, labelId, 1);
		  Thread.sleep(1000);
		  page.text.inputText(TextStyle.TEXTFIELD,"entity.countChange",super.bcf.getTimeStamp().substring(4));
		  Thread.sleep(1000);
		  
		  logger.info("fill the affected project and configuration");
		  labelId=page.otherElements.getLabelId(LabelStyle.TEXTFIELD,"更改影响项目及配置",0);
		  page.text.openTextBox(TextStyle.IDININPUT, labelId, 1);
		  Thread.sleep(1000);
		  page.text.inputText(TextStyle.TEXTFIELD,"entity.affectProjects","PartChange_affectedProject_" + changeOrder);
		  Thread.sleep(1000);
		  
		  logger.info("fill the supplier");
		  labelId=page.otherElements.getLabelId(LabelStyle.TEXTFIELD,"供应商",0);
		  page.text.openTextBox(TextStyle.IDININPUT, labelId, 1);
		  Thread.sleep(1000);
		  page.text.inputText(TextStyle.TEXTFIELD,"entity.supplier","PartChange_supplier_" + changeOrder);
		  Thread.sleep(1000);
